...
Page.prototype._initPage = function _initPage() {
    this._autoresizes.find(".order-message").on("input", this._resizeTextarea);
}


Page.prototype._resizeTextarea = function _resizeTextarea( evt ) {
    var textarea = evt.currentTarget;
    var textwrap = textarea.parentNode.querySelector(".textwrap");

    textwrap.textContent = textarea.value;
    textarea.style.height = textwrap.clientHeight + "px";
}